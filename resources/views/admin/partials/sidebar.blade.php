<aside id="layout-menu" class="layout-menu menu-vertical menu">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">CarBlissBD</span>
        </a>
    ...
    <ul class="menu-inner py-1">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Sell Report">Sell Report</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="#" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Customer Report">Profit Loss</div>
                    </a>
                </li>
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Attribute Type">Attribute Type</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="#" class="menu-link">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon icon-base bx bx-basket"></i>
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="All Order List">All Order List</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Product Replacement">Product Replacement</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Attribute Type">Sale/Order Return</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Attribute">Order Request</div>
                    </a>
                </li>
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon icon-base bx bx-globe-alt"></i>
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Social Link">Social Link</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="#" class="menu-link">
                ...
                <li class="menu-item">
                    <a href="#" class="menu-link">
                        <div data-i18n="Subscriber Content">Subscriber Content</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="#" class="menu-link">
