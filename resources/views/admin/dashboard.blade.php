                ...
                <div class="d-flex align-items-end row">
                    ...
                    <div class="col-5">
                        <div class="card-body pb-0 text-end">
                            <img src="{{ asset('backend') }}/assets/img/illustrations/prize-light.png" width="91"
                        ...
                        <div class="card-body pt-lg-6">
                            <div class="report-list">
                                <div class="report-list-item rounded-2 mb-4">
                                    <div class="d-flex align-items-center">
                                        <div class="report-list-icon shadow-xs me-4">
                                            <img src="{{ asset('backend') }}/assets/svg/icons/paypal-icon.svg"
                                ...
                                <div class="report-list-item rounded-2 mb-4">
                                    <div class="d-flex align-items-center">
                                        <div class="report-list-icon shadow-xs me-4">
                                            <img src="{{ asset('backend') }}/assets/svg/icons/credit-card-icon.svg"
                                ...
                                <div class="report-list-item rounded-2">
                                    <div class="d-flex align-items-center">
                                        <div class="report-list-icon shadow-xs me-4">
                                            <img src="{{ asset('backend') }}/assets/svg/icons/wallet-icon.svg"
                    ...
                    <ul class="p-0 m-0">
                        <li class="d-flex mb-6">
                            <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <i class="icon-base bx icon-lg bx-up-arrow-alt text-success me-2"></i>
                                    <span>12.8%</span>
                                </div>
                            </div>
                        </li>
                        <li class="d-flex mb-6">
                            <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <i class="icon-base bx icon-lg bx-down-arrow-alt text-danger me-2"></i>
                                    <span>- 8.5% </span>
                                </div>
                            </div>
                        </li>
                ...
                <div class="col-12 col-sm-6 col-md-3 col-lg-6 mb-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img src="{{ asset('backend') }}/assets/img/icons/unicons/computer.png" alt="computer"
                                        class="rounded" />
                                </div>
                                <div class="dropdown">
                    ...
                    <table class="table table-sm text-nowrap table-border-top-0">
                        ...
                        <tbody class="table-border-bottom-0">
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('backend') }}/assets/img/products/oneplus-lg.png"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('backend') }}/assets/img/products/magic-mouse.png"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('backend') }}/assets/img/products/imac-pro.png" alt="Apple"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('backend') }}/assets/img/products/note10.png" alt="Samsung"
                                            height="32" width="32" class="me-3" />
                                        <div class="d-flex flex-column">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('backend') }}/assets/img/products/iphone.png" alt="Apple"
                                            height="32" width="32" class="me-3" />
                                        <div class="d-flex flex-column">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('backend') }}/assets/img/products/mi-tv.png" alt="Xiaomi"
                                            height="32" width="32" class="me-3" />
                                        <div class="d-flex flex-column">
                                ...
                                <td>
                                    <span class="badge bg-label-danger rounded-pill p-1_5 me-3"><i
                                            class="icon-base bx bx-tv icon-xs"></i></span>
                                    Smart TV
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('backend') }}/assets/img/products/logitech-mx.png"
